...
# objetivo: Graficar el voltaje de un potenciómetro en un display OLED 128x64 usando I2C con MicroPython
...
# funcion creada por el autor del video proporcionado en moodle para graficar en el oled
...
if __name__ == '__main__':
    ...
    # esta parte se comento debido a que no se uso ni pico ni esp8266
    # if PLACA:
    ...
    # aquí configuramos el i2c y el pin del potenciómetro para el esp32
    ...
    # esta funcion se encarga de leer el valor del potenciómetro y graficarlo en el oled constantemente sin parar
    while True:
        volts = pot.read_u16() * FACTOR
        t,x,y = plot_time(volts,t,x,y)
